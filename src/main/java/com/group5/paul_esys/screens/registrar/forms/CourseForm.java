...
public class CourseForm extends javax.swing.JFrame {
    ...
    private static final int MIN_COURSE_NAME_LENGTH = 2;
    private static final int MAX_COURSE_NAME_LENGTH = 100;
    private static final int MAX_DESCRIPTION_LENGTH = 500;
    private static final Pattern COURSE_NAME_PATTERN = Pattern.compile("^[A-Za-z0-9 .,'()\\-/&]+$");
    ...
    private boolean isValidForm() {
        ...
        if (showValidationError(
            FormValidationUtil.validateMappedSelection("Department", cbxDep.getSelectedItem(), departmentIdByName)
        )) {
            return false;
        }
    ...
    private void saveCourse() {
        ...
        course
            .setCourseName(FormValidationUtil.normalizeOptionalText(txtCourse.getText()))
     ...
     */
        ...
        private void initComponents() {
                ...
                jPanel1.add(btnCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 410, 100, -1));

                btnSave.setBackground(new java.awt.Color(255, 234, 234));
                btnSave.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
                btnSave.setText("Save");
                btnSave.addActionListener(this::btnSaveActionPerformed);
                jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 410, 100, -1));
                ...
                layout.setHorizontalGroup(
                        ...
                        .addComponent(windowBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE)
