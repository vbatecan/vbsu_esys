...
public class StudentEnrollmentForm extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(StudentEnrollmentForm.class.getName());
    ...
    private void buildStudentEmail() {
        ...
        String firstName = txtFirstName.getText().trim().toLowerCase().replace(" ", "");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new StudentEnrollmentForm().setVisible(true));
    }
